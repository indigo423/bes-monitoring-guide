...
.Monitor for CIFS Share NetLogon in `poller-configuration.xml`
[source, xml]
----
...
=== BlackBerry TCP ports

==== TCP Port: Admin Service (HTTP)
This component monitor tests the ability of a BES Admin service to accept incoming sessions by HTTP.
By default it monitors TCP port `38180`.
...
<service name="HTTP-BlackBerry-Admin-Service" interval="300000" user-defined="false" status="on">
    ...
    <parameter key="host-name" value="bb-admin-service"/>
...
This component monitor tests the ability of a BES Admin service to accept incoming sessions by HTTPS.
By default it monitors TCP port `38443`.
...
This component monitor tests the ability of a BES Licensing service to accept incoming sessions by HTTPS.
By default it monitors TCP port `3333`.

.Monitoring connectivity to Licensing Server in `poller-configuration.xml`
[source, xml]
----
<service name="TCP-BlackBerry-Licensing-Server" interval="300000" user-defined="false" status="on">
    <parameter key="retry" value="3" />
    <parameter key="banner" value="*" />
    <parameter key="port" value="3333" />
    <parameter key="timeout" value="3000" />
    <parameter key="rrd-repository" value="/var/lib/opennms/rrd/response" />
    <parameter key="rrd-base-name" value="bb-licensing" />
    <parameter key="ds-name" value="bb-licensing" />
</service>

<monitor service="TCP-BlackBerry-Licensing-Server" class-name="org.opennms.netmgt.poller.monitors.TcpMonitor"/>
----

==== TCP Port: Universal Device Service
This component monitor tests the ability of a BES Universal Device service to accept incoming sessions by HTTPS.
By default it monitors TCP port `6443`.

.Monitoring connectivity to Universal Device Service in `poller-configuration.xml`
[source, xml]
----
<service name="TCP-BlackBerry-Universal-Device-Service" interval="300000" user-defined="false" status="on">
    <parameter key="retry" value="3" />
    <parameter key="banner" value="*" />
    <parameter key="port" value="6443" />
    <parameter key="timeout" value="3000" />
    <parameter key="rrd-repository" value="/var/lib/opennms/rrd/response" />
    <parameter key="rrd-base-name" value="bb-uds" />
    <parameter key="ds-name" value="bb-uds" />
</service>

<monitor service="TCP-BlackBerry-Universal-Device-Service" class-name="org.opennms.netmgt.poller.monitors.TcpMonitor"/>
----

==== TCP Port: BlackBerry Management Studio
This component monitor tests the ability of a BES Management Studio to accept incoming sessions by HTTPS.
By default it monitors TCP port `7443`.

.Monitoring connectivity to Management Studio in `poller-configuration.xml`
[source, xml]
----
<service name="TCP-BlackBerry-Management-Studio" interval="300000" user-defined="false" status="on">
    <parameter key="retry" value="3" />
    <parameter key="banner" value="*" />
    <parameter key="port" value="7443" />
    <parameter key="timeout" value="3000" />
    <parameter key="rrd-repository" value="/var/lib/opennms/rrd/response" />
    <parameter key="rrd-base-name" value="bb-mgmt-stdio" />
    <parameter key="ds-name" value="bb-mgmt-stdio" />
</service>

<monitor service="TCP-BlackBerry-Management-Studio" class-name="org.opennms.netmgt.poller.monitors.TcpMonitor"/>
----
